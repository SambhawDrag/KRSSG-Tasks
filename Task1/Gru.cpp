...
using namespace std;
void* clientThread(void *arg);                 //Functions to create threads for multithreading
...
int main(int argc, char *argv[])
{
    ...
    while(1)                                               //Accepting multiple connections via threads
    {
...
void* clientThread(void *arg)                 //Client's Thread
{
...
void* socketThread(void *arg)            //Minion's thread: MULTITHREADED
{
  int newSocket = *((int *)arg);
